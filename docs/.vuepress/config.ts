...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    nav: [
      { text: '首页', link: '/' },
      { text: 'Java', link: '/pages/a9075a/'},
      //{ text: '科研', link: '/pages/68f68f/'},
      //{ text: '生活', link: '/pages/25d10b/'},
      { text: '算法', link: '/pages/bc95b0/'},
      {
        text: '索引',
        link: '/archives/',
        items: [
    ...
    author: {
      name: 'jinhua', // 必需
      link: 'https://github.com/jinhua0', // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '知乎',
          link: 'https://www.zhihu.com/people/zhi-qing-72-50',
        },
        {
        ...
        },
        {
          ...
          title: 'blibli',
          link: 'https://space.bilibili.com/352135891?spm_id_from=333.337.0.0',
        },
        {
          iconClass: 'icon-youjian',
          title: '邮箱',
          link: 'er2578912608@163.com',
        },
      ],
    },
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        ...
        options: {
          ...
          owner: 'jinhua', // GitHub仓库所有者
          admin: ['jinhua'], // 对仓库有写权限的人
